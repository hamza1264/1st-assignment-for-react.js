    ...
    <div style={container}>
      ...
      <div style={grid}>
        {project.map((cert, index) => (
          ...
          >
            <img src={cert.img} alt={cert.title} style={img} />
